...
1. Download and extract the correct build from [v0.1.4](https://github.com/modecir/fast-cutvid/releases/tag/v0.1.4), and install FFmpeg and FFprobe. Follow the [operator guide](OPERATOR_GUIDE.md).
