...
fastCutVid is a native, open-source video cutter for macOS, Windows, and Linux. It combines a focused Premiere-style timeline with a portable JSON cut format that humans and AI agents can render in exactly the same way.
